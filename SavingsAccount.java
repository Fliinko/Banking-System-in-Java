...
class SavingsAccount extends Account implements Serializable{
    ...
    public SavingsAccount(String currency, float money, int USER_NO, int ACCOUNT_NUMBER, int CARD_COUNTER){
        super(currency, money, USER_NO, ACCOUNT_NUMBER, CARD_COUNTER);
    }

    //For Joint Account
    public SavingsAccount(String currency, float money, int USER_NO, int USER_NO2, int ACCOUNT_NUMBER, int CARD_COUNTER){
    ...
    public void newSavings(ArrayList<SavingsAccount> applicationList, ArrayList<SavingsAccount> savingsList){

        String tempCurrency;
        float tempMoney;
        int tempUserNo, tempUserNo2, tempCardCt;
        int tempAccNo = savingsList.length();
        char choice;
        ...
        switch(choice){
            case 'R':
                ...
                applicationList.add(new SavingsAccount(tempCurrency, tempMoney, tempUserNo, tempAccNo, tempCardCt));
            ...
            case 'J':
                ...
                applicationList.add(new SavingsAccount(tempCurrency, tempMoney, tempUserNo, tempUserNo2, tempAccNo, tempCardCt));
                System.out.println("Application Successful, Kindly wait for acceptance\n");
        } 
    }

    public void listAllSavings(ArrayList<SavingsAccount> applicationList){
